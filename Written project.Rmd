...
where a is the goal line, and b and c are the imaginary lines between the shooter and the posts.
Source: https://www.omnicalculator.com/math/triangle-angle#how-to-find-the-angle-of-a-triangle
...
where a, b and c are numeric vectors of length 2 representing the points of the triangle.
...
In particular, the threshold set for this study a threshold of 0.5. In order to run the Logistic Regression algorithm, the package **glm** [reference this shit] from CRAN is used.
